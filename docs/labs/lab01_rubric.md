...
- Adds personal style through color schemes, fonts, or layout adjustments
- Demonstrates creativity while maintaining functionality; makes additional improvements beyond minimum

### Meets Expectations
- Updates name, bio, and contact information accurately
- Makes at least one visual customization (colors, fonts, or images)
- Content is clear and professional; all links work correctly

### Does Not Meet Expectations
- Minimal or no personalization; placeholder text remains throughout site
- No visual customization attempted
- Content contains errors, broken links, or changes break the site
...
- Makes connections between technical skills and course goals
- Shows awareness of growth and what still needs improvement

### Meets Expectations
- Completes reflection with honest assessment identifying at least one challenge and one success
- Demonstrates genuine engagement with the learning process
- Addresses prompt questions adequately

### Does Not Meet Expectations
- Reflection is missing, incomplete, or superficial
- Shows no evidence of critical thinking about the process
- Does not address prompt questions or appears rushed
...
- Live site is polished and fully functional with all links working
- Goes beyond minimum requirements; shows attention to detail

### Meets Expectations
- Submits all required deliverables (GitHub repo link, live site link) that work correctly
- Repository contains all required files and site displays correctly
- Submitted by deadline

### Does Not Meet Expectations
- Missing required deliverables or links don't work
- Repository is incomplete or site is non-functional
